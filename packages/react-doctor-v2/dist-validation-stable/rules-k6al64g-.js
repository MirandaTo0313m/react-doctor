...
var ReactDoctorCancelledError = class extends ReactDoctorError {
  name = "ReactDoctorCancelledError";
  constructor(message = "React Doctor run was cancelled.", options) {
    super(message, {
      ...options,
      code: "react-doctor/cancelled",
    });
  }
};
...
var ReactDoctorConfigNotFoundError = class extends ReactDoctorConfigError {
  name = "ReactDoctorConfigNotFoundError";
  constructor(message = "React Doctor config was not found.", options) {
    super(message, {
      ...options,
      code: "react-doctor/config-not-found",
    });
  }
};
...
var ReactDoctorProjectError = class extends ReactDoctorError {
  name = "ReactDoctorProjectError";
  rootDirectory;
  constructor(rootDirectory, message, options = {}) {
    super(message, {
      ...options,
      code: options.code ?? "react-doctor/project-error",
    });
    this.rootDirectory = rootDirectory;
  }
};
var ReactDoctorProjectNotFoundError = class extends ReactDoctorProjectError {
  name = "ReactDoctorProjectNotFoundError";
...
var ReactDoctorPackageJsonNotFoundError = class extends ReactDoctorProjectError {
  name = "ReactDoctorPackageJsonNotFoundError";
  constructor(rootDirectory, options) {
...
var ReactDoctorNoReactDependencyError = class extends ReactDoctorProjectError {
  name = "ReactDoctorNoReactDependencyError";
  constructor(rootDirectory, options) {
...
var ReactDoctorAmbiguousProjectError = class extends ReactDoctorProjectError {
  name = "ReactDoctorAmbiguousProjectError";
  candidates;
  constructor(rootDirectory, candidates, options) {
    super(
      rootDirectory,
      `Multiple React projects found in ${rootDirectory}: ${candidates.join(", ")}.`,
      {
        ...options,
        code: "react-doctor/ambiguous-project",
      },
    );
...
var ReactDoctorCheckSkippedError = class extends ReactDoctorCheckError {
  name = "ReactDoctorCheckSkippedError";
  constructor(checkId, message, options) {
    super(checkId, message, {
      ...options,
      code: "react-doctor/check-skipped",
    });
  }
};
...
var ReactDoctorUnsupportedRuntimeError = class extends ReactDoctorError {
  name = "ReactDoctorUnsupportedRuntimeError";
  constructor(message, options) {
    super(message, {
      ...options,
      code: "react-doctor/unsupported-runtime",
    });
  }
};
var ReactDoctorTimeoutError = class extends ReactDoctorError {
  name = "ReactDoctorTimeoutError";
  constructor(message, options) {
    super(message, {
      ...options,
      code: "react-doctor/timeout",
    });
  }
};
var ReactDoctorReportError = class extends ReactDoctorError {
  name = "ReactDoctorReportError";
  constructor(message, options) {
    super(message, {
      ...options,
      code: "react-doctor/report-error",
    });
  }
};
...
const readPnpmWorkspacePatterns = async (rootDirectory) => {
  try {
    return parsePnpmWorkspacePatterns(
      await fs.readFile(path.join(rootDirectory, "pnpm-workspace.yaml"), "utf8"),
    );
  } catch {
    return [];
  }
...
const hasPackageJson = async (directory) => {
  try {
    return (await fs.stat(path.join(directory, PACKAGE_JSON_FILENAME))).isFile();
  } catch {
    return false;
  }
};
...
const readTypeScriptDirectoryOptions = async (
  ...
  try {
    const directory = path.dirname(tsconfigPath);
    const config = parseJsonWithComments(await fs.readFile(tsconfigPath, "utf8"));
...
const readGitignorePatterns = async (rootDirectory) => {
  try {
    return (await fs.readFile(path.join(rootDirectory, ".gitignore"), "utf8"))
      .split(/\r?\n/)
...
//#endregion
export {
  ReactDoctorRunnerUnavailableError as A,
  ReactDoctorError as C,
  ReactDoctorProjectError as D,
  ReactDoctorPackageJsonNotFoundError as E,
  ReactDoctorUnsupportedRuntimeError as M,
  isReactDoctorError as N,
  ReactDoctorProjectNotFoundError as O,
  toReactDoctorErrorInfo as P,
  ReactDoctorConfigNotFoundError as S,
  ReactDoctorNoReactDependencyError as T,
  ReactDoctorCancelledError as _,
  DEPENDENCIES_RULE_ID as a,
  ReactDoctorCheckSkippedError as b,
  reactProjectStructureRule as c,
  defineRule as d,
  readPackageJson as f,
  ReactDoctorAmbiguousProjectError as g,
  SOURCE_FILE_EXTENSIONS as h,
  REACT_ARCHITECTURE_RULE_ID as i,
  ReactDoctorTimeoutError as j,
  ReactDoctorReportError as k,
  reactDoctorOxlintPlugin as l,
  PACKAGE_JSON_FILENAME as m,
  createRuleRegistry as n,
  DEAD_CODE_RULE_ID as o,
  IGNORED_DIRECTORY_NAMES as p,
  ruleRegistry as r,
  runCodebaseAnalysis as s,
  coreRules as t,
  reactDoctorOxlintRules as u,
  ReactDoctorCheckError as v,
  ReactDoctorInvalidConfigError as w,
  ReactDoctorConfigError as x,
  ReactDoctorCheckFailedError as y,
};

//# sourceMappingURL=rules-k6al64g-.js.map
