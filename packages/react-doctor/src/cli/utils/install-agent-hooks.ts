...
const buildAgentHookScript = (): string =>
  [
    ...
    "    ./node_modules/.bin/react-doctor --verbose --diff --fail-on warning --offline",
    "    return",
    "  fi",
    "",
    "  if command -v react-doctor >/dev/null 2>&1; then",
    "    react-doctor --verbose --diff --fail-on warning --offline",
    "    return",
    "  fi",
    "",
    "  if command -v pnpm >/dev/null 2>&1; then",
    "    pnpm dlx react-doctor@latest --verbose --diff --fail-on warning --offline",
    "    return",
    "  fi",
    "",
    "  if command -v npx >/dev/null 2>&1; then",
    "    npx --yes react-doctor@latest --verbose --diff --fail-on warning --offline",
    "    return",
    "  fi",
    "",
