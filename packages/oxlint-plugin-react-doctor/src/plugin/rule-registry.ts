...
import { jsxKey } from "./rules/correctness/jsx-key.js";
import { jsxNoDuplicateProps } from "./rules/correctness/jsx-no-duplicate-props.js";
import { jsxNoScriptUrl } from "./rules/correctness/jsx-no-script-url.js";
...
import { noChildrenProp } from "./rules/correctness/no-children-prop.js";
import { noDanger } from "./rules/correctness/no-danger.js";
...
import { noDirectMutationState } from "./rules/correctness/no-direct-mutation-state.js";
...
import { noIsMounted } from "./rules/correctness/no-is-mounted.js";
...
import { noRenderReturnValue } from "./rules/correctness/no-render-return-value.js";
...
import { noStringRefs } from "./rules/correctness/no-string-refs.js";
...
import { noUnknownProperty } from "./rules/correctness/no-unknown-property.js";
...
import { requireRenderReturn } from "./rules/correctness/require-render-return.js";
...
export const reactDoctorRules = [
  {
    key: "react-doctor/a11y-alt-text",
    id: "a11y-alt-text",
    source: "react-doctor",
    framework: "global",
  ...
  {
    key: "react-doctor/a11y-anchor-is-valid",
  ...
  {
    key: "react-doctor/a11y-click-events-have-key-events",
  ...
  {
    key: "react-doctor/a11y-heading-has-content",
  ...
  {
    key: "react-doctor/a11y-html-has-lang",
  ...
  {
    key: "react-doctor/a11y-iframe-has-title",
  ...
  {
    key: "react-doctor/a11y-label-has-associated-control",
  ...
  {
    key: "react-doctor/a11y-no-autofocus",
  ...
  {
    key: "react-doctor/a11y-no-distracting-elements",
  ...
  {
    key: "react-doctor/a11y-no-redundant-roles",
  ...
  {
    key: "react-doctor/a11y-no-static-element-interactions",
  ...
  {
    key: "react-doctor/a11y-role-has-required-aria-props",
  ...
  {
    key: "react-doctor/a11y-tabindex-no-positive",
  ...
  {
    key: "react-doctor/scope-exhaustive-deps",
  ...
  {
    key: "react-doctor/scope-no-adjust-state-on-prop-change",
  ...
  {
    key: "react-doctor/scope-no-chain-state-updates",
  ...
  {
    key: "react-doctor/scope-no-derived-state",
  ...
  {
    key: "react-doctor/scope-no-event-handler",
  ...
  {
    key: "react-doctor/scope-no-initialize-state",
  ...
  {
    key: "react-doctor/scope-no-pass-data-to-parent",
  ...
  {
    key: "react-doctor/scope-no-pass-live-state-to-parent",
  ...
  {
    key: "react-doctor/scope-no-reset-all-state-on-prop-change",
